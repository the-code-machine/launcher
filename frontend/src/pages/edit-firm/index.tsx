...
export default function EditFirmPage(): JSX.Element {
  ...
  const handleDelete = async () => {
    ...
    setLoading(true)
    try {
      await axios.delete(`${API_BASE_URL}/firms/${firmId}`)
  ...
  return (
    <div className="container mx-auto p-4 bg-white flex-grow flex flex-col h-full">
      <div>
        ...
        <p className="text-gray-500 mb-4">Update your business information and settings</p>
        
        <div className="mb-4">
          <div className="inline-flex rounded-md border pb-0 text-sm">
            <button 
              className={`px-4 py-2 rounded-l-md ${activeTab === 'general' ? 'bg-gray-100' : 'bg-white'}`}
              onClick={() => handleTabChange('general')}
            >
              General Information
            </button>
            <button 
              className={`px-4 py-2 rounded-r-md ${activeTab === 'branding' ? 'bg-gray-100' : 'bg-white'}`}
        ...
        <form onSubmit={handleSubmit}>
          ...
          {success && (
            <Alert className="mb-6 bg-green-50 text-green-800 border-green-200">
              ...
              <AlertDescription>Your firm profile has been updated successfully</AlertDescription>
            </Alert>
          )}
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-600 mb-4">
                      Upload your business logo to be displayed on invoices and other documents.
                    </p>
          ...
          <div className="flex justify-between mt-8">
            <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
              <DialogTrigger asChild>
                <Button variant="destructive" type="button" className="bg-red-600 hover:bg-red-700">
                  Delete Firm
                </Button>
              </DialogTrigger>
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Are you sure you want to delete this firm?</DialogTitle>
                  <DialogDescription>
                    This action cannot be undone. This will permanently delete your firm
