...
import { useGetSaleInvoicesQuery, useDeleteSaleInvoiceMutation } from '@/redux/api/saleInvoiceApi'
                  ...
                  {isLoading ? (
                    ...
                    filteredInvoices?.map((invoice) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <Badge
                            variant={invoice.saleType === 'cash' ? 'outline' : 'secondary'}
                            className={invoice.saleType === 'cash' ? 'bg-green-50 text-green-700 border-green-200' : ''}
                          >
                            {invoice.saleType === 'cash' ? 'Cash' : 'Credit'}
                          </Badge>
                        </TableCell>
