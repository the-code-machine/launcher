...
const LoginPage = () => {
  ...
  const verifyOtp = async (e: FormEvent, forceReplace = false) => {
    ...
    try {
      ...
      if (err.response?.status === 403 && err.response?.data?.force_logout) {
        setDeviceLimitError(err.response.data.detail);
        setCanReplaceDevice(err.response.data.can_replace || false);
  ...
  // Handle device replacement confirmation
  const handleReplaceDevice = async () => {
    setShowDeviceLimitDialog(false);
    // Create a synthetic event to pass to verifyOtp
    const syntheticEvent = {
      preventDefault: () => {},
    } as FormEvent;
    await verifyOtp(syntheticEvent, true);
  };
  ...
  return (
    <>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Authenticate with OTP for enhanced security
                    </p>
                  </div>
                </div>
      ...
      <AlertDialog open={showDeviceLimitDialog} onOpenChange={setShowDeviceLimitDialog}>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <p className="mt-1">
                    If you continue, this device will replace your oldest registered device. 
                    You&lsquo;ll need to log in again on that device.
                  </p>
                </div>
              </div>
            </div>
