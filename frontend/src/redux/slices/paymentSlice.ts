...
type PaymentFormData = Omit<CreatePaymentDTO, 'firmId' | 'createdAt' | 'updatedAt'>;
...
// Validation function
export function validatePaymentForm(formData: PaymentFormData): Record<string, string> {
