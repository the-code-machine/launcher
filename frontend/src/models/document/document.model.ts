...
export enum DocumentType {
   ...
   * Update Document DTO
   */
  export type UpdateDocumentDTO = Partial<Omit<Document, 'id' | 'createdAt' | 'updatedAt'>>;
  
  /**
   * Create Document Item DTO
   */
  export type CreateDocumentItemDTO = Omit<DocumentItem, 'id' | 'createdAt' | 'updatedAt'>;
  
  /**
   * Create Document Charge DTO
   */
  export type CreateDocumentChargeDTO = Omit<DocumentCharge, 'id' | 'createdAt' | 'updatedAt'>;
  
  /**
   * Create Stock Movement DTO
   */
  export type CreateStockMovementDTO = Omit<StockMovement, 'id' | 'createdAt' | 'updatedAt'>;