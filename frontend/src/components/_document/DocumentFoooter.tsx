...
const DocumentFooter: React.FC = () => {
  ...
  const handleAdditionalAmountChange = (field: 'shipping' | 'packaging' | 'adjustment', value: string) => {
    dispatch({ 
      type: 'UPDATE_FIELD', 
      payload: { 
        field, 
  ...
  const getFieldValue = (field: 'shipping' | 'packaging' | 'adjustment'): string => {
            ...
            <Card className="border shadow-sm">
              <CardContent className="p-4 space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex w-32">
                    <Input
                      ...
                      onChange={(e) => 
                        handleAdditionalAmountChange('packaging', e.target.value)
                      }
                      placeholder="0.00"
                      className="text-right"
                    />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex w-32">
                    <Input
                      ...
                      onChange={(e) => 
                        handleAdditionalAmountChange('adjustment', e.target.value)
                      }
                      placeholder="0.00"
                      className="text-right"
                    />
                ...
                <div className="flex items-center mt-2">
                  ...
                  />
                  <Label htmlFor="roundOff" className="text-xs font-medium ml-2">
                    Round Off
                  </Label>
                ...
                <div className="bg-primary/10 p-3 rounded-md mt-2">
                  <div className="flex items-center justify-between">
                    <Label className="font-medium text-base text-primary">Total</Label>
