...
const GSTR2Report = () => {
  ...
  const gstInvoices = purchaseInvoices?.filter(invoice => {
    // Only include invoices that have GST
    const hasGst =invoice.items && invoice.items && invoice?.items.some(item => 
      item.taxType && 
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold">GSTR-2 Report</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 print:hidden">
        ...
        <Card className="bg-purple-50 border-purple-200">
          <CardContent className="p-4">
            <p className="text-sm text-gray-500">Input Tax Credit</p>
        ...
        <CardContent>
                  ...
                  {gstInvoices && gstInvoices.length > 0 ? (
                    ...
                    <TableRow>
                      <TableCell colSpan={8} className="text-center py-4 text-gray-500">
                        No GST purchase invoices found for the selected period
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
          ...
          <div ref={printRef} className="hidden print:block">
            ...
            <div className="text-center mb-4">
              ...
              <h3 className="text-lg font-semibold mt-4 border-b-2 border-gray-300 pb-2">GSTR-2 Report</h3>
            </div>
            ...
            <div className="mb-6 border border-gray-300 p-4 bg-gray-50">
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <div>
                  <p><strong>Input Tax Credit:</strong> ₹{totals.totalTax.toFixed(2)}</p>
                </div>
              </div>
            </div>
            
            {/* GST Invoices Table */}
            <h4 className="text-base font-medium mb-2">GST Purchase Invoices</h4>
            <table className="w-full border-collapse mb-6">
              <thead>
                <tr className="bg-gray-200">
                  ...
                  <th className="border border-gray-300 p-2 text-left">Input Tax Credit</th>
                </tr>
              </thead>
              <tbody>
                {!isLoading && !isError && gstInvoices && gstInvoices.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan={8} className="border border-gray-300 p-2 text-center">No GST purchase invoices found</td>
                  </tr>
                )}
              </tbody>
              <tfoot>
